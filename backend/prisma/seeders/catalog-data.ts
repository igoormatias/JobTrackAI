...
export const SOURCES = ["gupy", "linkedin", "programathor"] as const;
...
export const TITLES: Record<(typeof AREAS)[number], string[]> = {
...
export const SALARY_BY_SENIORITY: Record<(typeof SENIORITIES)[number], { min: number; max: number }> = {
