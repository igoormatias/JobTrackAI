...
const getSourceLabel = (source: DashboardInterview["source"]): string =>
  source === "google" ? "Google" : "Pipeline";
    ...
    () =>
      [...interviews].sort(
        (a, b) =>
          ...
          a.jobTitle.localeCompare(b.jobTitle, "pt-BR"),
      ),
    [interviews],
  );
            ...
            {sortedInterviews.map((interview) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-2 line-clamp-1 text-sm text-muted-foreground">{interview.companyName}</p>
