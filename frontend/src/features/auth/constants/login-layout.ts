export const LOGIN_LAYOUT = {
  ...
  grid:
    "relative z-10 mx-auto grid min-h-screen w-full max-w-[1280px] grid-cols-1 gap-8 px-4 py-8 sm:px-6 sm:py-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(320px,480px)] lg:items-center lg:gap-12 lg:px-10 lg:py-14 xl:px-14",
  heroPanel: "order-2 flex min-w-0 flex-col justify-center lg:order-1",
  authPanel: "order-1 flex min-w-0 flex-col justify-center lg:order-2",
  authCard:
    "w-full rounded-2xl border border-border/80 bg-card/90 p-8 shadow-xl backdrop-blur-xl sm:p-10",
  ...
  productGrid: "grid grid-cols-2 gap-3 sm:gap-4",
  productCard:
